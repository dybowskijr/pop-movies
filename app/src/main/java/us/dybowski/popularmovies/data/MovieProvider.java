...
public class MovieProvider extends ContentProvider {
    ...
    static final int REVIEWS_WITH_MOVIE_ID = 102;
    static final int TRAILERS_WITH_MOVIE_ID = 103;
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, MovieContract.PATH_MOVIE + "/#/" + MovieContract.PATH_REVIEWS, REVIEWS_WITH_MOVIE_ID);
        matcher.addURI(authority, MovieContract.PATH_MOVIE + "/#/" + MovieContract.PATH_TRAILERS, TRAILERS_WITH_MOVIE_ID);
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case MOVIES:
            {
                retCursor = movieDbHelper.getReadableDatabase().query(
                        ...
                        null,
                        null,
                        sortOrder); //TODO has to come from settings...; also, if favorites...
                break;
            }
            // "weather/*"
            case MOVIE_WITH_ID: {
                retCursor = movieDbHelper.getReadableDatabase().query(
                        ...
                        null,
                        null,
                        "1"); //TODO has to come from settings...; also, if favorites...
                break;
            }
            // "weather"
            case REVIEWS_WITH_MOVIE_ID: {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case REVIEWS_WITH_MOVIE_ID: {
                ...
                if ( _id > 0 )
                    returnUri = MovieContract.ReviewEntry.buildReviewWithIdUri(_id);
                else
                    throw new android.database.SQLException("Failed to insert row into " + uri);
                break;
            }
            case TRAILERS_WITH_MOVIE_ID: {
                ...
                if ( _id > 0 )
                    returnUri = MovieContract.TrailerEntry.buildTrailerWithIdUri(_id);
                else
                    throw new android.database.SQLException("Failed to insert row into " + uri);
                break;
            }
